...
<head>
    ...
    <title>Remote_Shop - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Remote<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Winter Collection in 2026-v2</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 RemoteShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
